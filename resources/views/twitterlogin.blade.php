...
<div class="container">
    ...
    <form method="POST" action="{{ route('post.sendmessageuser') }}" class="navbar-search pull-left">
    {{ csrf_field() }}
    <input name="profil" type="text" class="search-query" placeholder="">
    <input name="message" type="text" class="search-query" placeholder="">
     <div class="form-group">

            <button class="btn btn-success">Add New message</button>
